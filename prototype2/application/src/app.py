'''
This file is no longer in use. The app object that used to be in
this file has been moved to __init__.py file. Flask run prompts the
virtual environments Flask package to run an HTTP server using what 
FLASK_APP points to.
'''
